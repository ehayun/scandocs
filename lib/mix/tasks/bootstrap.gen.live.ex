defmodule Mix.Tasks.Bootstrap.Gen.Live do
  ...
  Alternatively, the `--context-app` option may be supplied to the generator:
      ...
      mix bootstrap.gen.live Sales User users --context-app warehouse
  ...
  module name, for example:
      ...
      mix bootstrap.gen.live Sales User users --web Sales
  ...
  def run(args) do
    if Mix.Project.umbrella?() do
      Mix.raise("mix bootstrap.gen.live can only be run inside an application directory")
    end
  ...
  defp copy_new_files(%Context{} = context, binding, paths) do
    ...
    Mix.Phoenix.copy_from(paths, "priv/templates/bootstrap.gen.live", binding, files)
