defmodule ScandocWeb.EmployeeLiveTest do
  ...
  @create_attrs %{date_of_birth: ~D[2010-04-17], full_name: "some full_name", hashed_password: "some hashed_password", is_admin: true, is_freezed: true, role: "some role", zehut: "some zehut"}
