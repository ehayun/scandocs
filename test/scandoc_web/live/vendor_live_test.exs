defmodule ScandocWeb.VendorLiveTest do
  ...
  @create_attrs %{address: "some address", contact_name: "some contact_name", phone_number: "some phone_number", vendor_name: "some vendor_name", vendor_site: "some vendor_site"}
